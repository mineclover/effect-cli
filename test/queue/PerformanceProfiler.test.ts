  ...
  describe("Profiling Sessions", () => {
    ...
    it("should track failed operations", async () => {
      const test = Effect.gen(function*() {
        ...
        const session = yield* profiler.startProfiling("failed-op", "network", "network")
  ...
  describe("Performance Statistics", () => {
    it("should generate performance statistics", async () => {
      const test = Effect.gen(function*() {
        ...
        const session2 = yield* profiler.startProfiling("perf-2", "filesystem", "filesystem")
  ...
  describe("Data Export", () => {
    ...
    it("should export profiling data in CSV format", async () => {
      const test = Effect.gen(function*() {
        ...
        // Generate some data
        const session = yield* profiler.startProfiling("csv-test", "filesystem", "filesystem")
